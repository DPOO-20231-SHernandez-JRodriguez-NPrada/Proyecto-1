...
public class Reserva {
    ...
    public Reserva(String documento, String estadoReserva, int personasEsperadas, String fechaIni, String fechaFin, ArrayList<HabitacionReserva> habitacionesReservadas,Huesped huesped) {
